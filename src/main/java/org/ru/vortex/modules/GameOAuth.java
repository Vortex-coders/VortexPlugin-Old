...
public class GameOAuth {
    ...
    public static final SelectMenu menu = StringSelectMenu
        .create("oauth")
        .addOption("Confirm", "oauth.confirm", "Confirm request.", fromFormatted("✅"))
        .addOption("Reject", "oauth.reject", "Deny request.", fromFormatted("❌"))
        .addOption("Information", "oauth.information", "Look up all information about the player.", fromFormatted("🔎"))
    ...
    private static void remove(StringSelectInteractionEvent event, Func2<Administration.PlayerInfo, Player, EmbedBuilder> func) {
